...
<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-100 px-4 sm:px-6">
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-md w-full max-w-sm sm:max-w-md" data-testid="login-container">
            ...
            <!-- Login Button -->
            <button @click="login" 
                class="w-full bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 transition text-lg sm:text-base"
